...
df.to_csv(r'../Mochnacki/data_er1_moch_parity.csv', index=False)
...
df.to_csv(r'../Mochnacki/data_er2_moch_parity.csv', index=False)
...
df.to_csv(r'../Mochnacki/data_er3_moch_parity.csv', index=False)
...
error1_avg = calc_avg(r'../Mochnacki/data_er1_moch_parity.csv')
print("1 Error average: ", error1_avg)
error2_avg = calc_avg(r'../Mochnacki/data_er2_moch_parity.csv')
print("2 Error average: ", error2_avg)
error3_avg = calc_avg(r'../Mochnacki/data_er3_moch_parity.csv')
